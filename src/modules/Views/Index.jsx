...
function Index({ btnUp }) {
  ...
  const assets = {
    nails:
      "https://res.cloudinary.com/devsy44f3/image/upload/v1660111956/Products/Ecommerce-Magistral/img/Captura_de_pantalla_2022-08-10_011125_jhoqle.png",
  };
  const bannerIcons = [
    {
      id: 1,
  ...
  return (
    <ContentContainer>
      ...
      <Title
        title={
          "Ten las uñas que siempre quisiste tener a un solo click de distancia"
        }
      />
